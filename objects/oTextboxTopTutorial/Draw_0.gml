...
textbox_y = camera_get_view_y(view_camera[0]);//Y-position of the textbox.

//Setup
if setup == false
{
	setup = true;
	draw_set_font(global.fontHUD);//Set the font for drawing.
...
txtb_spr_h = sprite_get_height(txtb_spr);//Height of the sprite for the textbox.
