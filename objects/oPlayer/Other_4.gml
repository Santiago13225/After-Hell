...
}else if room == rm_House_Level1 || room == rm_House_Level2{
...
}else if (room == rm_Island_Level1 || room == rm_Island_Level2 || room == rm_Island_Level3){
	audio_play_sound(sndIslandTheme, 8, true);
}else if (room == rm_WaterStation_Level1 || room == rm_WaterStation_Level2 || room == rm_WaterStation_Level3){
	audio_play_sound(sndWaterStationTheme1, 8, true);
}else if (room == rm_CityBlock_Level1 || room == rm_CityBlock_Level2 || room == rm_CityBlock_Level3){
	audio_play_sound(sndCityBlockTheme, 8, true);
}else if (room == rm_Yard_Level1 || room == rm_Yard_Level2){
